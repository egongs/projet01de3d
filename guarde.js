let Guarde = function (posX, posY, couleur) {
    this.posX = posX;
    this.posY = posY;
    this.couleur = couleur
}

Guarde.prototype.dessinerGaucheFull = function () {
    objC2D.save()
    objC2D.beginPath()
    ...
    objC2D.rotate(40 * Math.PI / 180)
    objC2D.fillStyle = this.couleur
    objC2D.fillRect(4, 10, 7, 12)
    objC2D.closePath()
    objC2D.restore()
}
Guarde.prototype.dessinerDroiteFull = function () {
    objC2D.save()
    objC2D.beginPath()
    objC2D.fillStyle = "white"
...
Guarde.prototype.dessinerSpawn = function () {
    objC2D.save()
    objC2D.beginPath()
    objC2D.fillStyle = "white"
...
Guarde.prototype.dessinerGaucheMid = function () {
    objC2D.save()
    objC2D.beginPath()
    objC2D.fillStyle = "white"
    objC2D.fillRect(0, 0 / 2, 12, 10)
...
Guarde.prototype.dessinerDroiteMid = function () {
    objC2D.save()
    objC2D.beginPath()
    objC2D.fillStyle = "white"
    objC2D.fillRect(3, 0 / 2, 12, 10)
...
Guarde.prototype.dessinerGauche = function () {
    objC2D.save()
    objC2D.beginPath()
    objC2D.fillStyle = "white"
    objC2D.fillRect(0, 0 / 2, 12, 10)
...
Guarde.prototype.dessinerDroite = function () {
    objC2D.save()
    objC2D.beginPath()
    objC2D.fillStyle = "white"
    objC2D.fillRect(3, 0 / 2, 12, 10)
